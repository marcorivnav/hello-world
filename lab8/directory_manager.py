...
class DirectoryManager:
    ...
    def add_record(self, record):
        with open(DIRECTORY_FILE, 'a') as directory_file:
            ...
            logging.info("Added a record successfully")
        ...
        with open(DIRECTORY_FILE, 'r') as directory_file:
            for line in directory_file:
                ...
                if (line != str(record).replace("'", "\"")):
                    ...
                    logging.info("Deleted the record " + str(record))
        ...
        with open(DIRECTORY_FILE, "r") as directory_file:
            ...
            for line in directory_file:
                ...
                if (line_dict[field_name] == value):
                    found = True
                    logging.info("Found the record " + str(line_dict))
                    return line_dict

            if (not found):
                logging.error("Did not find the record with " +field_name + " " + value)
